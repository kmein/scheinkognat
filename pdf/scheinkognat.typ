...
#let script-font(lang) = {
  let map = (
    ...
    "heb": ("Ezra SIL", "Noto Sans Hebrew"),
    "yid": ("Ezra SIL", "Noto Sans Hebrew"),
    "san": ("Noto Serif Devanagari",),
    "pli": ("Noto Serif Devanagari",),
    "hin": ("Noto Serif Devanagari",),
    "guj": ("Noto Sans Gujarati", "Noto Serif Devanagari"),
    "ben": ("Noto Sans Bengali", "Noto Serif Devanagari"),
